...
void print_benchmark(const std::string& name, int n, int b, int d, int samples, double median, double mean, double low_mean, double high_mean, double std_dev, double low_std_dev, double high_std_dev) {
    if (name.size() > 37)
    ...
    std::cout << std::right << std::setw(15) << suitable_prefix(median).str() << std::endl;

    std::cout << std::left << std::setw(38) << "    n:" + std::to_string(n) + "    b:" + std::to_string(b) + "    d:" + std::to_string(d);
    std::cout << std::right << std::setw(15) << suitable_prefix(mean).str();
    std::cout << std::right << std::setw(15) << suitable_prefix(low_mean).str();
    std::cout << std::right << std::setw(15) << suitable_prefix(high_mean).str() << std::endl;
    std::cout << std::right << std::setw(38 + 15) << suitable_prefix(std_dev).str();
    std::cout << std::right << std::setw(15) << suitable_prefix(low_std_dev).str();
    std::cout << std::right << std::setw(15) << suitable_prefix(high_std_dev).str() << std::endl
              << std::endl;
}
